...
const strategies: Array<{ name: string; options: Model['options'] }> = [
    ...
    { name: 'Hybrid + Most Fractional', options: { nodeSelection: 'hybrid', branching: 'most-fractional' } },
    { name: 'Hybrid + Pseudocost', options: { nodeSelection: 'hybrid', branching: 'pseudocost' } },
    { name: 'Depth-first + Pseudocost', options: { nodeSelection: 'depth-first', branching: 'pseudocost' } },
    { name: 'Best-first + Pseudocost', options: { nodeSelection: 'best-first', branching: 'pseudocost' } },
];
...
// Print results
console.log('Strategy'.padEnd(35) + 'Time (ms)'.padStart(12) + 'Result'.padStart(15) + 'Feasible'.padStart(10));
