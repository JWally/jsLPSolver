...
var solve_arb = function(home_currency, rates){
    ...
    // Set up the target in the constraints
    constraints["tgt"] = {max: 10000, min: 1.1};
    
    // Set up the target in the variables
    rates["tgt"] = {};
    ...
    return solver.Solve(JSON.parse(JSON.stringify(model)));
}



for(var i = 0; i < ary.length; i++){
    console.log("ARB: " + i + ":" , solve_arb("USD", ary[i]))
}
